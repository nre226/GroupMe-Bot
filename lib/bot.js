...
class Bot {
    ...
    static hassanStatement() {
        ...
        if (it === 0 || 1) {
            ...
            if (number === 0) {
                return `I was ${verb}${singular}${noun} when- WHAT DO YOU PEOPLE WANT? I'M TRYING TO TELL A STORY HERE`;
            } else {
                return `I was ${verb}${number}${noun}s when- WHAT DO YOU PEOPLE WANT? I'M TRYING TO TELL A STORY HERE`;
            }
    ...
    static checkMessage(message) {
        ...
        const hassanRollRegex = /^\/rh ((Str|Dex|Con|Int|Wis|Cha|str|dex|con|int|wis|cha)|([0-9]{1,2})?d([0-9]{1,4}))$/;
